...
const products = [`гречка`, `макароны`, `рис`, `овсянка`, `горох`];
...
const ridingAnimals = [...horses, ...donkeys];
...
const updatedAnimals = getRarityProperty(ridingAnimals);